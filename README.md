...
Code coverage reports of the unit tests added for Part 3 and Part 5 of the project can be found in the [Code_coverage_and_unit_tests](https://github.com/johnslara-arch/signal_project/tree/master/Code_coverage_and_unit_tests) directory. This directory also contains screenshots proving the 
